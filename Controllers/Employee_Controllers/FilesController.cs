...
namespace OfficePortal.Controllers.Employee_Controllers
{
    public class FilesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,File_Name,SocialStatusRecord_Id")] File @file)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,File_Name,SocialStatusRecord_Id")] File @file)
        {
            if (id != @file.Id)
            {
                return NotFound();
